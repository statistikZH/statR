test_that("config file correctly initiated", {
  ...
  testthat::expect_equal(names(config_file), c("config_name","config_path"))
  ...
  testthat::expect_equal(getOption("statR_email"), "datashop@statistik.zh.ch")
...
test_that("second entry is added correctly",{
  ...
  testthat::expect_error(
    addUserConfig("test", testthat::test_path("example_userconf", "blabla"),store_path = confdir),
...
test_that("an entry can not be overwritten with the addUserConfig-function",{
  ...
  testthat::expect_error(addUserConfig("test", testthat::test_path("example_userconf", "test"),store_path = confdir), "Diese Konfiguration existiert bereits")
  testthat::expect_error(addUserConfig("test", testthat::test_path("example_userconf", "testone"),store_path = confdir), "Der Konfigurationsname:")
...
test_that("own header config is loaded",{
  ...
  testthat::expect_equal(getOption("statR_email"), "blabla@statistik.zh.ch")
