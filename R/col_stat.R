...
stattheme_data <- {
  ...
  # Akzentfarben ZH Web
  x$stattheme_data$zhwebaccent <- c(
    "#009ee0",
    "#0070B4",
    "#7F3DA7",
    "#D40053",
  ...
  x$stattheme_data$zhwebdataviz <- c(
    "#0070B4",
    "#00407C",
    "#00797B",
    "#8A8C00",
  ...
  x$stattheme_data$zhextralight <- c(
    "#9FCBE5",
    "#9FDADA",
    "#B4DEB8",
    "#F3EBAE",
  ...
  x$stattheme_data$zhultralight <- c(
    "#BFDCED",
    "#BFE6E6",
    "#CDE9D0",
    "#F8F1CA",
  ...
  #--------------------------------------------------------------------------
  x$stattheme_data$zhlikert5gr <- c(
    "#F09B7A",
    "#E93F53",
    "#6EBD72",
    "#B3DA8A",
  ...
  x$stattheme_data$zhlikert5br <- c(
    "#F09B7A",
    "#E93F53",
    "#3F98CD",
    "#9BC7B7",
  ...
  x$stattheme_data$zhlikert6gr <- c(
    "#6EBD72",
    "#A5D485",
    "#DCEB98",
    "#f2a975",
  ...
  x$stattheme_data$zhlikert6br <- c(
    "#3F98CD",
    "#7FB9DD",
    "#9FDADA",
    "#F7C5A1",
  ...
  x$stattheme_data$zhseq <- c(
    x$stattheme_data$zhultralight[3],
    x$stattheme_data$zh[2],
    x$stattheme_data$zhdarker[1],
    "#2A526A"
  )

  x$stattheme_data$zhlakeseq <- c(
    x$stattheme_data$zhlake[8],
