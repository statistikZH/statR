...
- Die Palette *zhwebdataviz* enthält die Farben, die für Infografiken und Visualisierungen im Web genutzt werden sollen.
- Die Palette *zhwebaccent* enthält die Akzentfarben des Designsystems. Diese sollten aber vor allem für Hintergründe oder Schriften und nicht für Visualisierungen verwendet werden, da sie nicht optimiert sind für barrierefreie Grafiken.
