...
Bei Grafiken ist es besonders wichtig, dass diese ohne Benachteiligung bestimmter Personengruppen, erfasst werden können. Dies betrifft unterschiedliche Zielgruppen, wie Sehbehinderte, Sehgeschwächte, Menschen mit Rot-Grün-Blindheit. Um die Zugänglichkeit zu erhöhen, bieten sich verschiedene Strategien an:

- Daten zur Grafik können zusätzlich als csv oder -html-Tabelle einbinden

- Einen Alternativtext (alt-Text) hinterlegen welcher beschreibt was auf Grafik abgebildet ist und nennt wo die Daten zu finden sind

- Farbpaletten wählen für Farbsehschwächen optimiert sind

- Die Aussage einer Grafik sollte nicht ausschließlich nur über die Farbe wahrnehmbar sein

- Die Komplexität der Grafiken sollte auf ein Minimum beschränkt werden

Einige dieser Punkte lassen sich bei der Erstellung der Grafiken in R abfangen.
...
- Wenn möglich sollten unterschiedliche Kategorien nicht nur über Farben sondern auch über Schraffuren oder unterschiedliche Formen (Punkt oder Linientypen) unterscheidbar sein. Auch die direkte Beschriftung der Kategorien bietet sich hier als Werkzeug an (Wenn möglich).
