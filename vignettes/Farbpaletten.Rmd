...
vignette: >
  %\VignetteIndexEntry{Farbpaletten}
...
Mit der Funktion `display.statcol.all()` können alle Farbpaletten angezeigt werden:
...
- die Palette 'zhwebdataviz' enthält die Farben, die auf dem Web genutzt werden sollen
- die Palette 'zhwebaccent' enthält die Akkzentfarben des Designsystems. Diese sollten ber vor allem für Hintergründ everwendet werden und nicht für Visualisierungen, da sie nicht barrierefrei sind.
