...
Neben Funktionen zur Excel-Dateierzeugung und Visualisierungen beinhaltet `statR` auch zwei weitere Hilfsfunktionen. Die eine erleichtert das Erstellen von deskriptiven Übersichtstabellen. Die andere kann zur Generierung von individualisierten Farbpaletten verwendet werden.
