...
einzelnes Excel-Sheet exportiert. Für 
...
Entsprechend kann es zu Darstellungsproblemen kommen, wenn der Input für die 
Argumente `metadata` oder `source` zu lange ist. In solchen Fällen muss die 
Zeilenhöhe manuell angepasst werden. Alternativ kann man die Zeilenumbrüche 
manuell vorzunehmen, indem man den Text über mehrere Vektorelemente verteilt 
